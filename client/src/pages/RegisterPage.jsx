...
// This function points to the new /api/auth/register endpoint
...
const RegisterPage = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      // Reload the entire app to log the new user in
              ...
              >
                ...
                <motion.div variants={itemVariants}>
                  <Typography variant="h6" sx={{ mb: 4, opacity: 0.95, lineHeight: 1.6 }}>
                    Join thousands of investors who trust PortfolioManager to track and grow their wealth.
                  </Typography>
                </motion.div>
